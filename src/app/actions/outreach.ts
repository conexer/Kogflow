...
export async function sendOutreachEmail(lead: {
    ...
    try {
        ...
        const valueLine = pick(lead.priceReduced ? [
            ...
            `A visual refresh pairs really well with a price adjustment. I did this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website where any agent can upload a photo and get a professionally staged version in one click. No software needed.`,
            `Price drops get more attention when they come with new photos. I made this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — upload a listing photo, click once, and you get a fully furnished staged room in seconds. Extremely affordable and free to start.`,
            `Buyers who had the listing saved but never acted often re-engage when they see something new. I used <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app that stages any room in one click, at a fraction of what traditional staging costs.`,
            `A staged photo at the new price point can be exactly what moves a listing forward. <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> is a website that does this in one click — upload any photo and get a professional staged result in seconds. Free to try.`,
            `Staged photos at a new price point often get buyers back on the phone. I put this together on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging. Extremely affordable, and free to start.`,
            `A visual update after a price drop can change how buyers perceive the whole listing. I created this with <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that stages any room in one click. No software, just your browser.`,
            `Buyers browsing at the new price point respond better to a furnished photo. I made this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app where you upload a photo and get a staged room in one click. Extremely affordable and free to try.`,
            `A fresh photo set can be the nudge buyers on the fence need. I did this using <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click website for virtual staging that's extremely affordable and free to start.`,
            `Staged photos help buyers see value, especially after a price change. I built this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app where any agent can stage a room in one click. Much cheaper than traditional staging.`,
            `Buyers often reconsider a listing when the price drops and new photos appear. This was created on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that turns any listing photo into a staged room in one click. Extremely affordable and free to try.`,
            `A new visual at a new price point can completely shift buyer perception. I did this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging. Free to start, works on any listing photo.`,
        ] : dom >= 45 ? [
            `Listings with staged photos tend to get more saves and showings. I made this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app where you upload any listing photo and get a staged room in one click. Extremely affordable and free to try.`,
            `Buyers scroll past empty rooms but stop at furnished versions. I created this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that stages any room in one click. Free to try, no software needed.`,
            `A visual refresh at this point in the listing cycle can bring in new buyer interest. I built this with <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging that's extremely affordable.`,
            `Staged photos give buyers something to react to — and listings with furnished photos get more inquiries. I used <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> for this — upload a photo, click once, get a staged room. Free to start.`,
            `Buyers who saw the listing before often reconsider when they see new photos. I made this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that takes one click to go from an empty room to a furnished, professional photo. Extremely affordable.`,
            `Sometimes a listing just needs one strong photo to start getting traction again. I did this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app where any agent can stage a room in one click, in seconds. Free to try.`,
            `A furnished room photo can completely change how buyers feel about a space. I created this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click website for virtual staging. Extremely affordable and free to start.`,
            `Listings that get a visual refresh after some market time often see renewed showing activity. I built this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app where you upload a photo and get a staged result in one click. No software needed.`,
            `Buyers spend more time on listings with staged photos. I put this together on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that stages any room in one click. Extremely affordable and free to try.`,
            `At this point in the listing, something new in the photos can re-ignite buyer interest. I made this with <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging. Free to start, works on any listing photo.`,
            `Staged photos help buyers picture themselves in the space. I created this using <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website where you upload any photo and get a professionally staged room in one click. Extremely affordable.`,
            `A fresh visual can be exactly what moves a listing that has been sitting. I used <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app that stages rooms in one click, at a fraction of traditional staging costs. Free to try.`,
            `Buyers who passed on the listing before often come back when they see new photos. I built this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click website for virtual staging. Extremely affordable and free to start.`,
            `A furnished photo at this stage can re-engage buyers who had the listing saved but never acted. I did this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app that takes one click to stage any room. Free to try.`,
            `Listings that show furnished rooms tend to get more second looks. I put this together on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that stages any room in one click. Extremely affordable and free to start.`,
        ] : dom <= 7 ? [
            `Now is a great time to make the photos pop while the listing is getting fresh traffic. I made this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app where you upload any listing photo and get a staged room in one click. Extremely affordable and free to try.`,
            `The first week on market is when listings get the most attention. I created this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that stages any room in one click, in seconds. Free to try, no software needed.`,
            `Buyers make fast decisions on new listings — a furnished photo right now can be the difference between a scroll-past and a showing request. I built this with <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging. Extremely affordable.`,
            `Great timing to have staged photos working while the listing is fresh. I did this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — upload any photo, click once, and get a professionally staged room in seconds. Free to start.`,
            `New listings get the most views in the first few days — a furnished photo right now can really move the needle. I used <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> for this — a website that stages rooms in one click. Extremely affordable.`,
            `Buyers browsing new listings respond well to furnished photos — it helps them make faster decisions. I made this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging. Free to try, works on any listing photo.`,
            `The opening days of a listing are prime time for buyer interest. I put this together on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app where any agent can stage a room in one click. Extremely affordable and free to start.`,
            `Buyers comparing multiple new listings spend more time on the one with furnished photos. I created this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that takes one click to go from an empty room to a professional staged photo. Free to try.`,
            `A strong first impression in the first week can set the pace for the whole listing. I built this with <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click website for virtual staging. Extremely affordable and free to start.`,
            `New listings get the most organic traffic — a furnished photo while it's fresh can drive real showing activity. I did this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — upload a photo, click once, staged in seconds. Free to try.`,
            `Buyers making quick decisions on new listings stop longer on furnished photos. I used <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> for this — a web app that stages any room in one click. Extremely affordable and free to start.`,
            `The first few days on market are when photos matter most. I created this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website where you upload any photo and get a staged room in one click. Free to try.`,
            `Staged photos help new listings make a strong first impression and get more saves. I built this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging. Extremely affordable and free to start.`,
            `Now is exactly the right time to have great photos working for you. I put this together on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that stages rooms in one click. Free to try, works on any listing photo.`,
            `A furnished photo right at launch can significantly improve how many buyers save the listing. I made this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging. Extremely affordable and free to try.`,
        ] : [
            `Staged photos help buyers picture themselves in the space and lead to more saves and showings. I made this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app where you upload any listing photo and get a staged room in one click. Extremely affordable and free to try.`,
            `Buyers scroll past empty rooms but stop at furnished ones. I created this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that stages any room in one click, in seconds. Free to start, no software needed.`,
            `A furnished photo can make buyers feel more connected to the space right away. I built this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging. Extremely affordable and free to try.`,
            `Staged listings get more saves, more clicks, and more showing requests. I did this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website where any agent can stage a room in one click. Extremely affordable and free to start.`,
            `Buyers spend more time on listings with furnished photos — and more time usually means more interest. I used <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> for this — upload a photo, click once, staged room in seconds. Free to try.`,
            `A furnished version of a room gives buyers something to respond to emotionally. I put this together on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click website for virtual staging. Extremely affordable and free to start.`,
            `Staged photos tend to lead to faster offers and stronger buyer interest. I created this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app that stages any room in one click, at a fraction of traditional staging costs. Free to try.`,
            `Buyers who can picture themselves in a space are more likely to schedule a showing. I built this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website where you upload any photo and get a professionally staged result in one click. Free to start.`,
            `A good staged photo can be the thing that makes a buyer pick up the phone. I made this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging. Extremely affordable and free to try.`,
            `Listings with furnished photos generate more inquiries. I put this together on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that stages rooms in one click. Free to try, works on any listing photo.`,
            `Buyers make faster decisions when they can visualize a furnished space. I did this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a web app where any agent can stage a room in one click. Extremely affordable and free to start.`,
            `A staged photo helps buyers see past an empty room and focus on the space itself. I created this using <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website that takes one click to stage any listing photo. Free to try.`,
            `Staged listings get more saves and showings on average. I built this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging. Extremely affordable and free to start.`,
            `Buyers browsing multiple listings stop longer on furnished photos. I put this together on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a website where you upload a photo and get a staged room in one click. Free to try.`,
            `A furnished photo gives buyers a reason to imagine living there. I made this on <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> — a one-click web app for virtual staging. Extremely affordable and free to start.`,
        ]);

        // ── Video walkthrough lines (12 variations) ─────────────────────────
        const videoLine = pick([
            `The same web app also generates <strong>virtual video walkthroughs</strong> in one click — buyers can take an immersive tour of the property from their phone before ever visiting.`,
            `<a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> also creates <strong>virtual video walkthroughs</strong> in one click — buyers get a full tour experience without setting foot in the property.`,
            `Beyond photos, the same website can turn any staged room into a <strong>virtual video walkthrough</strong> in one click — great for out-of-town buyers who want to explore before committing to a showing.`,
            `It also generates <strong>virtual video walkthroughs</strong> from any staged photo — same web app, one more click, and buyers get an immersive tour from their phone.`,
            `<a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> can also create a <strong>virtual video walkthrough</strong> from the staged image in one click — great for buyers doing research before scheduling a visit.`,
            `The app also does <strong>virtual video walkthroughs</strong> — buyers can move through the staged space remotely, which tends to drive higher-quality showing requests.`,
            `You can also generate a <strong>virtual video walkthrough</strong> from the same web app in one click — buyers get a full property tour from wherever they are before deciding to visit.`,
            `<a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> also produces <strong>virtual video walkthroughs</strong> from staged photos in one click — an immersive experience that helps out-of-town buyers make faster decisions.`,
            ...
            `Beyond the staged photo, <a href="https://bit.ly/kogflow" style="color:#7c3aed;">Kogflow</a> can generate a <strong>virtual video walkthrough</strong> in one click — gives buyers who haven't visited yet a real feel for the space.`,
            `It also creates <strong>virtual video walkthroughs</strong> — same simple web app, one more click, and buyers get a full tour experience from their phone.`,
            `The same website also does <strong>virtual video walkthroughs</strong> from any staged room — useful for listings that attract a lot of remote or out-of-state buyer interest.`,
        ]);

        // ── Closing lines (12 variations) ────────────────────────────────────
        const closingLine = pick([
            `Try it yourself at <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a> — one click to stage any room, no credit card needed. Or just let me know if you want me to do a few more rooms first.`,
            `You can stage any room in one click at <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a> — free to start, no software needed. Happy to do more rooms for you in the meantime.`,
            `Free to start at <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a> — upload any listing photo and stage it in one click. Or just reply and I'll put together more rooms for you.`,
            `Happy to stage more rooms for free — or try it yourself at <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a>. One click, no credit card, no commitment.`,
            `No strings attached — just reply if you want more rooms done. And when you're ready, one click is all it takes at <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a>.`,
            `I can do more rooms for free — or try it yourself at <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a>. Upload a photo, click once, staged room in seconds.`,
            `Either way, happy to help — just reply if you want more rooms. Or try it in one click at <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a> anytime, free to start.`,
            `Free to try at <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a> — one click to stage any room. Happy to do more rooms for you first if you'd like to see a few more examples.`,
            `Just let me know if you want more rooms — happy to do them for free. The web app is free to try at <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a> — one click per room.`,
            `No obligation — happy to stage more rooms at no charge. Or start in one click at <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a> whenever you're ready. Extremely affordable.`,
            `I'm happy to do more rooms for free. When you're ready to try it yourself, it's one click at <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a> — free to start, no software needed.`,
            `Happy to keep going with more rooms at no cost — just reply. Or go to <a href="https://bit.ly/kogflow" style="color:#7c3aed;">bit.ly/kogflow</a> and stage any room in one click. Extremely affordable.`,
        ]);
